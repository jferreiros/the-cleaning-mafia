...
export default function HeroContact({ image, title, content, titleContact, subtitle, emailLabel, messageLabel, submitButton }) {
  ...
  return (
    <section >
      <div className="max-w-5xl mx-auto p-12 flex flex-col items-center justify-center gap-12 min-h-96 md:flex-row">
      <div className="flex-1">
        <img src={image} alt="About Us" className="w-full h-auto object-cover rounded-lg shadow-md" />
      </div>
      <div className="flex-1 mx-auto">
        <h2 className="text-3xl text-center text-primary font-bold mb-4">{titleContact}</h2>
